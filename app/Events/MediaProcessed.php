...
/**
 * L'aperçu et les caractéristiques d'un fichier sont prêts : la carte se
 * complète chez le déposant et dans les groupes concernés, sans sondage.
 */
class MediaProcessed implements ShouldBroadcastNow
{
    ...
    {
        return ['media_id' => $this->media->id, 'quality' => $this->media->quality_label];
    }
}
